...
class SimpleGeofence {
  ...
  @override
  SimpleGeofence fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
  ...
  @override
  List<SimpleGeofence> fromMapList(List<dynamic> dynamicDataList) {
    final List<SimpleGeofence> newFeedList = <SimpleGeofence>[];
  ...
  String toString() {
    return 'Item{id: $id, '
        ...
        'commentHeaderCount: $commentHeaderCount, '
