...
class OptimizedCacheImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget Function(BuildContext context) octoPlaceholderBuilder =
        placeholder != null ? _octoPlaceholderBuilder : null;
    final Widget Function(BuildContext context, ImageChunkEvent progress) octoProgressIndicatorBuilder =
    ...
    if (octoPlaceholderBuilder == null &&
      ...
      octoPlaceholderBuilder = (BuildContext context) => Container();
    }

    return LayoutBuilder(builder: (BuildContext ctx, BoxConstraints constraints) {
      int _constrainWidth = memCacheWidth;
      int _constrainHeight = memCacheHeight;
